...
import {CreateAndStartWorkspaceRequest, CreateAndStartWorkspaceResponse, GetOwnerTokenRequest, GetOwnerTokenResponse, GetWorkspaceRequest, GetWorkspaceResponse, InstanceUpdateRequest, InstanceUpdateResponse, ListWorkspacesRequest, ListWorkspacesResponse, StopWorkspaceRequest, StopWorkspaceResponse, UpdatePortRequest, UpdatePortResponse} from "./workspaces_pb.js";
...
export const WorkspacesService = {
  ...
  methods: {
     ...
     *
     * @generated from rpc gitpod.experimental.v1.WorkspacesService.InstanceUpdate
     */
    instanceUpdate: {
      name: "InstanceUpdate",
      I: InstanceUpdateRequest,
      O: InstanceUpdateResponse,
