...
/**
 * @generated from message gitpod.experimental.v1.InstanceUpdateRequest
 */
export class InstanceUpdateRequest extends Message<InstanceUpdateRequest> {
  /**
   * @generated from field: string instance_id = 1;
   */
  instanceId = "";

  constructor(data?: PartialMessage<InstanceUpdateRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime = proto3;
  static readonly typeName = "gitpod.experimental.v1.InstanceUpdateRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "instance_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InstanceUpdateRequest {
    return new InstanceUpdateRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InstanceUpdateRequest {
    return new InstanceUpdateRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InstanceUpdateRequest {
    return new InstanceUpdateRequest().fromJsonString(jsonString, options);
  }

  static equals(a: InstanceUpdateRequest | PlainMessage<InstanceUpdateRequest> | undefined, b: InstanceUpdateRequest | PlainMessage<InstanceUpdateRequest> | undefined): boolean {
    return proto3.util.equals(InstanceUpdateRequest, a, b);
  }
}

/**
 * @generated from message gitpod.experimental.v1.InstanceUpdateResponse
 */
export class InstanceUpdateResponse extends Message<InstanceUpdateResponse> {
  /**
   * @generated from field: gitpod.experimental.v1.WorkspaceInstance result = 1;
   */
  result?: WorkspaceInstance;

  constructor(data?: PartialMessage<InstanceUpdateResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime = proto3;
  static readonly typeName = "gitpod.experimental.v1.InstanceUpdateResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "result", kind: "message", T: WorkspaceInstance },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InstanceUpdateResponse {
    return new InstanceUpdateResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InstanceUpdateResponse {
    return new InstanceUpdateResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InstanceUpdateResponse {
    return new InstanceUpdateResponse().fromJsonString(jsonString, options);
  }

  static equals(a: InstanceUpdateResponse | PlainMessage<InstanceUpdateResponse> | undefined, b: InstanceUpdateResponse | PlainMessage<InstanceUpdateResponse> | undefined): boolean {
    return proto3.util.equals(InstanceUpdateResponse, a, b);
  }
}
