...
type WorkspacesServiceClient interface {
	...
	InstanceUpdate(context.Context, *connect_go.Request[v1.InstanceUpdateRequest]) (*connect_go.ServerStreamForClient[v1.InstanceUpdateResponse], error)
...
func NewWorkspacesServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) WorkspacesServiceClient {
	...
	return &workspacesServiceClient{
		...
		instanceUpdate: connect_go.NewClient[v1.InstanceUpdateRequest, v1.InstanceUpdateResponse](
			httpClient,
			baseURL+"/gitpod.experimental.v1.WorkspacesService/InstanceUpdate",
			opts...,
		),
...
type workspacesServiceClient struct {
	...
	instanceUpdate          *connect_go.Client[v1.InstanceUpdateRequest, v1.InstanceUpdateResponse]
...
// InstanceUpdate calls gitpod.experimental.v1.WorkspacesService.InstanceUpdate.
func (c *workspacesServiceClient) InstanceUpdate(ctx context.Context, req *connect_go.Request[v1.InstanceUpdateRequest]) (*connect_go.ServerStreamForClient[v1.InstanceUpdateResponse], error) {
	return c.instanceUpdate.CallServerStream(ctx, req)
}
...
type WorkspacesServiceHandler interface {
	...
	GetWorkspace(context.Context, *connect_go.Request[v1.GetWorkspaceRequest]) (*connect_go.Response[v1.GetWorkspaceResponse], error)
	// InstanceUpdate returns workspace once it changed.
	InstanceUpdate(context.Context, *connect_go.Request[v1.InstanceUpdateRequest], *connect_go.ServerStream[v1.InstanceUpdateResponse]) error
	// GetOwnerToken returns an owner token.
	GetOwnerToken(context.Context, *connect_go.Request[v1.GetOwnerTokenRequest]) (*connect_go.Response[v1.GetOwnerTokenResponse], error)
	// CreateAndStartWorkspace creates a new workspace and starts it.
	CreateAndStartWorkspace(context.Context, *connect_go.Request[v1.CreateAndStartWorkspaceRequest]) (*connect_go.Response[v1.CreateAndStartWorkspaceResponse], error)
...
func NewWorkspacesServiceHandler(svc WorkspacesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/gitpod.experimental.v1.WorkspacesService/InstanceUpdate", connect_go.NewServerStreamHandler(
		"/gitpod.experimental.v1.WorkspacesService/InstanceUpdate",
		svc.InstanceUpdate,
		opts...,
	))
...
func (UnimplementedWorkspacesServiceHandler) InstanceUpdate(context.Context, *connect_go.Request[v1.InstanceUpdateRequest], *connect_go.ServerStream[v1.InstanceUpdateResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("gitpod.experimental.v1.WorkspacesService.InstanceUpdate is not implemented"))
}
